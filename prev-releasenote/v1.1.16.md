<div>
  ...
  <h1>Eatbook (책 먹는 여우)</br></br>정식 버전 릴리즈v1.1.16</h1>
</div>  
...
### 이용 관련  
+ 오류, 오타 및 잘못 표기된 문구가 수정 됩니다.  
+ 소설 재생 페이지(스크립트)의 UI가 일부 개선 됩니다.  
    + 다음, 이전 에피소드 이동 시, 마지막 혹은 맨 처음 에피소드 일 경우 안내 메시지 표기  
+ 소설 재생 설정의 UI가 일부 개선 됩니다.  
    + 현재 사용중인 글꼴 하이라이트  
    + 현재 적용중인 TTS 재생 속도 하이라이트  